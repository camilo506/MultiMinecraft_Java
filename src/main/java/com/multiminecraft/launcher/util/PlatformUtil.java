    ...
    public static Path getLauncherDirectory() {
        ...
        switch (getOS()) {
            case WINDOWS:
                ...
                if (appData != null) {
                    launcherDir = Paths.get(appData, ".MultiMinecraft_Developer"); /** ruta de windows */
                } else {
                    launcherDir = Paths.get(userHome, ".MultiMinecraft_Developer"); /** ruta de windows */
                }
                break;

            case MACOS:
                launcherDir = Paths.get(userHome, "Library", "Application Support", "MultiMinecraft_Developer");
                /** ruta de mac */
                break;
            ...
            case LINUX:
                ...
                if (xdgData != null) {
                    launcherDir = Paths.get(xdgData, "MultiMinecraft_Developer"); /** ruta de linux */
                } else {
                    launcherDir = Paths.get(userHome, ".MultiMinecraft_Developer"); /** ruta de linux */
                }
                break;

            default:
                launcherDir = Paths.get(userHome, ".MultiMinecraft_Developer");
                /** ruta de linux */
                break;
        }
